...
def get_args_parser():
    ...
    # I/O
    parser.add_argument("--models", type=str, default="2toINF/X-VLA-Pt", help="Path or HF repo for pretrained XVLA")
    parser.add_argument("--output_dir", type=str, default="runnings", help="Directory to save checkpoints")

    # Data
    parser.add_argument("--train_metas_path", type=str, default="/root/gpufree-data/X-VLA/libero_goal_16/info.json", help="Path to training metadata")
